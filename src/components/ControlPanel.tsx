...
export default function ControlPanel() {
  ...
  return (
    <div className="absolute bottom-4 right-4 w-[28rem] bg-black/30 backdrop-blur-sm text-green-400 p-4 rounded-lg shadow-2xl border border-green-500/20 z-[1000] font-mono text-sm transition-all hover:bg-black/60">
